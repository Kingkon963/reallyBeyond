          ...
          <div className="mt-[43px] flex flex-col gap-[40px] lg:gap-[60px]">
            ...
            >
              <div className="w-[298px] xsp:w-[358px] lg:w-[498px] mx-[12px] mt-[22px]">
                <span className="text-[18px] text-green dark:text-black">
                  Fast, Secure and Optimized Websites, Mobile Apps and solutions
                  of all complexities
                </span>
                <p className="mt-0 text-[14px] lg:w-[498px] 3xl:w-[584px] leading-snug">
                  ...
                  your needs and make everything like a breeze for you. We make
                  sure you just sit back and relax while we develop your dream
                  app or website. A very small one page website to an enterprise
                  level solution - We can do it.
                </p>
                <h2 className="text-[18px] text-green dark:text-black mt-5">
                  Process:
                </h2>
                ...
                >
                  ...
                  <ListItem>
                    Testing: Each and every inch of your product will be tested
                    by Pros.
                  </ListItem>
                  <ListItem>
            ...
            >
              ...
              >
                ...
                <p className="mt-0 text-[14px] lg:w-[498px] 3xl:w-[557px] leading-snug">
                  Set of different processes and strategies to achieve all your
                  wishes. This is a long term bond between you and us. We go
                  through many discussions with you to come up with a solution
                  or set of services for your particular needs. You may want to
                  automate your organization or have a revolutionary idea, we
                  will work on it together. Having a multi-skilled team with
                  diverse experience and strong business acumen, We can deal
                  with all things design, technology keeping in mind your
