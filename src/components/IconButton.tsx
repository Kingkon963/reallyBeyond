  ...
  return (
    <div
      className={`flex gap-2 lg:gap-3 items-baseline ${
        hovered ? "text-orange" : "text-white"
      } transition-none`}
    >
      <svg
        width="17"
      ...
      >
        <path
          ...
          fill="white"
          className={`${hovered ? "fill-orange" : ""}`}
        />
      </svg>
      <span className="uppercase font-poppinsSemibold transition-none">
        LinkedIn
      </span>
    </div>
  );
      ...
      <span className="self-start">
        ...
        >
          <path
            ...
            className={`${hovered ? "fill-orange" : "fill-white"}`}
          />
          <path
