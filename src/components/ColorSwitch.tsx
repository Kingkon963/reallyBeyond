...
function ColorSwitch() {
  const [colorPref, setColorPref, deleteColorPref] = useLocalStorage<"bw" | "color">(
    "colorPref",
    "color"
  );
  ...
  return (
    <div ref={elRef} className="z-[1000] transition-none">
      <ul className="flex gap-[0px] absolute -right-[13px] bottom-[-20px] translate-y-full mr-4 lg:relative lg:bottom-auto lg:translate-y-0 lg:mr-6 transition-none">
        <li
